...
def logisticRegressionUtilizingScikit(data_type, data_path, hyper_parameter_tuning=False, search_type=None, cross_validation=False):
    ...
    if cross_validation == False:
        ...
        confusionDisplayObject.figure_.savefig(r'C:\Users\ahmet\Documents\ADHD Machine Learning\ADHD-adolescents-machine-learning\Data\Output\LogisticRegression\ConfusionMatrix' + data_type_string + '.png')
        ########################################### Plot ROC Curve #################################################
        ...
        plt.plot(falsePosRate_logisticRegression, truePosRate_logisticRegression, label='Lojistik Regresyon, AUC:' + str(logisticRegressionAUC), linestyle='solid', linewidth=3)
...
def main():
    ...
    logisticRegressionUtilizingScikit(data_type='combinedConnersAndDoctorsNotes'              , data_path=r"C:\Users\ahmet\Documents\ADHD Machine Learning\ADHD-adolescents-machine-learning\Data\CombinedConnersAndDoctorsNotes.csv",                    hyper_parameter_tuning=False, search_type='grid', cross_validation=True)
