...
fileToWritePath = r'C:\Users\ahmet\Documents\ADHD Machine Learning\ADHD-adolescents-machine-learning\Data\Parsing\CombinedDataConnersParentAndDoctorsNotes.csv'     # Combined Data
...
def combine(filePath1, filePath2, fileToWritePath):         # Combines the both data for each individual row w/o any scale reduction to binary.
    ...
    #***************************************** COMBINE THE DATA *******************************************************************************
    for i in range(0,len(csvConnersList)):
        csvFinalList.append(np.append(csvConnersList[i], csvDoctorsNotesList[i]))
